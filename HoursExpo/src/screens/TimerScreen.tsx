...
export const TimerScreen: React.FC<TimerScreenProps> = ({ route, navigation }) => {
  ...
  const startColor = lightProgress.interpolate({
    inputRange: [0, 1],
    outputRange: ['#1e1b4b', '#fbbf24'], // Deep purple to golden
  });

  const middleColor = lightProgress.interpolate({
    inputRange: [0, 1],
    outputRange: ['#312e81', '#f59e0b'], // Purple to light golden
  });

  const endColor = lightProgress.interpolate({
    inputRange: [0, 1],
    outputRange: ['#4c1d95', '#f97316'], // Lighter purple to amber
  });
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={styles.gradientContainer}>
        <LinearGradient
          colors={[startColor as any, middleColor as any, endColor as any]}
